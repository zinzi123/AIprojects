...
# Fetch the necessary API keys from environment variables
google_api_key = os.getenv("GOOGLE_API_KEY")  # Use Google API key for Gemini
...
vacation_planning_crew = Crew(
    ...
    manager_llm=ChatGoogleGenerativeAI(api_key=google_api_key, model="gemini-1.5-flash"),  # Use Google Gemini
